...
pub const ABSOLUTE_X_ADDR: u16 = 0x427;
pub const ABSOLUTE_X_OFFSET: u8 = 0x5A;
pub const ABSOLUTE_X_ADDR_OVERFLOW: u16 = 0x04A5;
pub const ABSOLUTE_X_OFFSET_OVERFLOW: u8 = 0x6A;

pub const INDIRECT_X_PTR_BASE: u8 = 0x3F;
pub const INDIRECT_X_OFFSET: u8 = 0x5A;
pub const INDIRECT_X_FINAL_PTR: u16 = INDIRECT_X_PTR_BASE.wrapping_add(INDIRECT_X_OFFSET) as u16;
...
pub const INDIRECT_X_FINAL_PTR_OVERFLOW: u16 =
    INDIRECT_X_PTR_BASE_OVERFLOW.wrapping_add(INDIRECT_X_OFFSET_OVERFLOW) as u16;

pub const INDIRECT_X_FINAL_ADDR_OVERFLOW: u16 = 0x0498;

pub const INDIRECT_X_PTR_BASE_PAGE_SPLIT: u8 = 0xFF;
pub const INDIRECT_X_OFFSET_PAGE_SPLIT: u8 = 0x00;
pub const INDIRECT_X_FINAL_PTR_PAGE_SPLIT: u16 =
    INDIRECT_X_PTR_BASE_PAGE_SPLIT.wrapping_add(INDIRECT_X_OFFSET_PAGE_SPLIT) as u16;

pub const INDIRECT_X_FINAL_ADDR_PAGE_SPLIT: u16 = 0x0428;
...
pub const INDIRECT_Y_BASE_ADDR_PAGE_SPLIT: u16 = 0x04D1;
