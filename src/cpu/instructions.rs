...
pub fn execute_opcode<M: Memory>(executor: &mut Executor<M>, opcode: Opcode) {
    match opcode {
        ...
        // LSR
        Opcode::LsrAccumulator => Lsr::accumulator(executor),
        Opcode::LsrZeropage => Lsr::zeropage(executor),
        Opcode::LsrZeropageX => Lsr::zeropage_x(executor),
        Opcode::LsrAbsolute => Lsr::absolute(executor),
        Opcode::LsrAbsoluteX => Lsr::absolute_x(executor),
        ...
        Opcode::RolZeropage => Rol::zeropage(executor),
        Opcode::RolZeropageX => Rol::zeropage_x(executor),
        Opcode::RolAbsolute => Rol::absolute(executor),
        Opcode::RolAbsoluteX => Rol::absolute_x(executor),
