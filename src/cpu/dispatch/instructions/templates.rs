...
pub fn read_immediate<F: FnOnce(&mut Cpu, u8)>(
    cpu: &mut Cpu,
...
pub fn read_zeropage<F: FnOnce(&mut Cpu, u8)>(
    cpu: &mut Cpu,
    memory: &mut MemoryMapping,
    f: F,
) -> ControlFlow<()> //
...
pub fn read_absolute<F: FnOnce(&mut Cpu, u8)>(
    cpu: &mut Cpu,
    memory: &mut MemoryMapping,
    f: F,
) -> ControlFlow<()> //
...
pub fn read_indirect_x<F: FnOnce(&mut Cpu, u8)>(
    cpu: &mut Cpu,
    memory: &mut MemoryMapping,
    f: F,
) -> ControlFlow<()> //
...
pub fn read_indirect_y<F: FnOnce(&mut Cpu, u8)>(
    cpu: &mut Cpu,
    memory: &mut MemoryMapping,
    f: F,
) -> ControlFlow<()> //
